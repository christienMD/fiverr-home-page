        ...
        <div className="relative">
          ...
          {isHovered && slides.length > 1 && (
            <>
              {currentSlide > 0 && (
                <ButtonBack
                  // className="absolute top-1/2 left-0 transform -translate-y-1/2 -translate-x-full bg-gray-50 rounded-full h-8 w-8 flex items-center justify-center shadow-md z-10 transition-all duration-300 hover:translate-x-2 group"
