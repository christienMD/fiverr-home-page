...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-around sm:justify-between items-center sticky z-40 top-0 border-b h-16 px-6 bg-white gap-5 sm:gap-3">
      <div className="flex items-center gap-3 md:gap-3 w-full">
        ...
        <div className="hidden sm:block w-full md:max-w-xl">
          {/* <AnimatedSearch /> */}
          <SearchInput />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          type="button"
          className="w-[2.375rem] hidden  h-[2.375rem] lg:inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700"
        >
          <svg
        ...
        <button
          type="button"
          className="hs-dropdown-toggle relative w-[2.375rem] h-[2.375rem] hidden lg:inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700"
          data-hs-offcanvas="#hs-offcanvas-right"
        >
          <EnvelopeIcon className="h-6 w-6" />
          <span className="absolute top-2 end-0 inline-flex items-center size-3 rounded-full border-2 border-white text-xs font-medium transform -translate-y-1/2 translate-x-1/2 bg-red-500 text-white">
